---
name: seo-schema
description: "Detectar, validar e gerar dados estruturados Schema.org (JSON-LD preferido). Use ao pedir 'schema', 'structured data', 'rich results', 'JSON-LD' ou 'markup'."
version: "2.3.1"
updated: "2026-09-25"
user-invocable: true
argument-hint: "[url]"
