...
This is enforced, not advisory: `"${CLAUDE_PROJECT_DIR}/.claude/skills/seo/scripts/claude-seo" run validate_backlink_report.py` fails
...
- **Command:** `"${CLAUDE_PROJECT_DIR}/.claude/skills/seo/scripts/claude-seo" run moz_api.py`
...
- **Command:** `"${CLAUDE_PROJECT_DIR}/.claude/skills/seo/scripts/claude-seo" run bing_webmaster.py`
...
- **Command:** `"${CLAUDE_PROJECT_DIR}/.claude/skills/seo/scripts/claude-seo" run commoncrawl_graph.py`
...
- **Command:** `"${CLAUDE_PROJECT_DIR}/.claude/skills/seo/scripts/claude-seo" run verify_backlinks.py`
