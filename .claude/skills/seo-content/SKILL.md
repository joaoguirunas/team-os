...
```bash
"${CLAUDE_PROJECT_DIR}/.claude/skills/seo/scripts/claude-seo" run content_humanize.py draft.md -o cleaned.md
cat draft.md | "${CLAUDE_PROJECT_DIR}/.claude/skills/seo/scripts/claude-seo" run content_humanize.py --json
```
